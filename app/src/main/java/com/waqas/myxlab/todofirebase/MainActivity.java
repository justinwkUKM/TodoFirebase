...
public class MainActivity extends AppCompatActivity {
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("OK",new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        ListItem listItem = new ListItem(listItemText,FirebaseAuth.getInstance().getCurrentUser().getEmail() );
    ...
    public void deleteAllListItems(){
        FirebaseDatabase.getInstance().getReference().child("task").removeValue();
        myListItems.clear();
        mAdapter.notifyDataSetChanged();
    ...
    private class ListItemsHolder extends RecyclerView.ViewHolder{
        ...
        public void bindData(ListItem s){
            mNameTextView.setText(s.getListItemText()+" by "+ s.getListItemCreator());
        }
    }
